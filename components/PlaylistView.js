...
export default function PlaylistView() {
  ...
  return (
    <div className="text-wrapped-white font-display p-4 md:p-8 overflow-y-auto max-h-[60vh] scrollbar-hide">
      <div className="max-w-4xl mx-auto">
        <header className="flex items-center gap-6 mb-8 mt-4">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-[1fr_1fr] gap-4 px-4 py-2 border-b border-white/10 text-[10px] font-bold uppercase tracking-widest text-white/40 mb-2">
            <div>Title</div>
